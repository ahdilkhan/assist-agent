...
export default function Tab2() {
  ...
  function computeAttainability() {
    ...
    // Group rows by program+groupId to handle "pick N" correctly
    const programGroupMap = {} // key: `program|groupId` → { nRequired, completedCount, totalCount }
