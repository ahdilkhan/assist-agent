    ...
    try {
      ...
      for (const { prog, arts, noArts } of programArts) {
        ...
        for (const na of noArts) {
          if (na.nRequired !== null) {
            console.log('[noArt item]', na.uniRequirement.prefix, na.uniRequirement.number, '| partOfPickGroup:', na.partOfPickGroup, '| nRequired:', na.nRequired, '| groupId:', na.groupId)
          }
          ...
          <div style={{
            ...
            <div>
              {(() => {
                ...
                console.log('[noArticulation full]', JSON.stringify(overlapData.noArticulation?.map(na => ({
                  prefix: na.uniReq.prefix, number: na.uniReq.number,
                  partOfPickGroup: na.partOfPickGroup,
                  coveredByAnotherOption: na.coveredByAnotherOption,
                  groupId: na.groupId,
                  nRequired: na.nRequired,
                }))))
                overlapData.rows.filter(r => r.nRequired !== null).forEach(r => {
